...
def find_apr_targets(stake_amounts_trb, aprs, target_aprs, total_tokens_active, avg_mint_amount, avg_fee, avg_block_time):
...
def plot_stake_scenarios(results, base_total_stake, avg_mint_amount, avg_fee, avg_block_time):
    ...
    targets = find_apr_targets(stake_amounts_trb, aprs, target_aprs, base_total_stake, avg_mint_amount, avg_fee, avg_block_time)
...
def run_scenarios_analysis(total_tokens_active, avg_mint_amount, avg_fee, avg_block_time):
    ...
    targets = plot_stake_scenarios(stake_results, total_tokens_active, avg_mint_amount, avg_fee, avg_block_time)
